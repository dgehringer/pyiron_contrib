...
JOB_CLASS_DICT['FreeEnergy'] = 'pyiron_contrib.protocol.jobs.free_energy'
JOB_CLASS_DICT['QuantumEquivalentTemperature'] = 'pyiron_contrib.protocol.jobs.quantum_equivalent_temperature'
JOB_CLASS_DICT['MurnaghanPotential'] = 'pyiron_contrib.protocol.jobs.potential_hypersurface'
